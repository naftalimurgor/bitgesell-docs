...
{                                                    (json object)
  ...
  "relayfee" : n,                                    (numeric) minimum relay fee for transactions in BGL/kB
  "incrementalfee" : n,                              (numeric) minimum fee increment for mempool limiting or BIP 125 replacement in BGL/kB
