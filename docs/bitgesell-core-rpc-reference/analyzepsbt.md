...
{                                   (json object)
  ...
  "estimated_feerate" : n,          (numeric, optional) Estimated feerate of the final signed transaction in BGL/kB. Shown only if all UTXO slots in the PSBT have been filled
