...
```json
{                                          (json object)
  "amount" : n,                            (numeric) The amount in BGL
  ...
  "details" : [                            (json array)
    {                                      (json object)
      ...
      "address" : "str",                   (string) The bitgesell address involved in the transaction.
...
```sh
BGL-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d"
```

```sh
BGL-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d" true
```

```sh
BGL-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d" false true
```

curl --user myusername --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "gettransaction", "params": ["1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d"]}' -H 'content-type: text/plain;' http://127.0.0.1:8334/
